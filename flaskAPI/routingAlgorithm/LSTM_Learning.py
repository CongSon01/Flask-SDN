...
class hostServerConnection(object):
    ...
    def find_shortest_path(self):
        ...
        print("----------------------------Duong tot nhat----------------------------" )
        self.sol.display_result()
        print("Tong so canh ok:", self.sol.number_label_1)
        print("Tong switch:", len(self.sol.get_result()))
